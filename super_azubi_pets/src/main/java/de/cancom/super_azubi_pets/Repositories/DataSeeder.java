...
public class DataSeeder implements CommandLineRunner {
    ...
    private void loadInitialAnimals() {
        ...
        standardAnimals.add(new Animal("Faultier", "🦥", 1, 1, 1, ""));
        ...
        standardAnimals.add(new Animal("Biber", "🦫", 3, 2, 2, ""));
        ...
        standardAnimals.add(new Animal("Thaddäus", "🦑", 5, 2, 3, ""));
        ...
        standardAnimals.add(new Animal("Gorilla", "🦍", 5, 5, 4, ""));
        ...
        standardAnimals.add(new Animal("Schlange", "🐍", 10, 1, 5, ""));
        ...
        standardAnimals.add(new Animal("Elefant", "🐘", 8, 5, 6, ""));
